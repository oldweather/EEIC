...
start = as.Date("1790-01-01")
end = as.Date("1835-01-01")
...
postscript(file="sym_anom_ts.ps",paper="a4",family='Helvetica',pointsize=16)
...
pushViewport(dataViewport(as.numeric(c(start,end)),c(-30,30)))
