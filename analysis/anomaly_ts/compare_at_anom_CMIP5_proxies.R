...
pdf(file="compare_at_anom_CMIP5_proxies.pdf",width=10,height=7,family='Helvetica',pointsize=16)
...
pushViewport(dataViewport(c(1790,1835),c(-2.5,0.6)))
grid.xaxis(main=T)
grid.text('Year',y=unit(-3,"lines"))
grid.yaxis(main=T)
grid.text('AT anomaly (C)',x=unit(-3.5,"lines"), rot=90)
popViewport()
pushViewport(dataViewport(c(1790,1835),c(-2.5,0.6),clip='on'))
