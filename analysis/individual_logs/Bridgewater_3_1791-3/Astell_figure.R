# Make a synthesis figure for the Astell
library(grid)
library(chron)
library(lattice)
library(maps)
...
sts2$Date<-chron(dates=as.character(sts2$V1),times=as.character(sts2$V2),
                           format=c(dates = "y/m/d", times = "h:m:s"))
tics = dates(c('1812/03/01','1812/06/01','1812/09/01','1812/12/01','1813/03/01','1813/06/01'),
      format="y/m/d")
ticl = c('1812/03','1812/06','1812/09','1812/12','1813/03','1813/06')
      
postscript(file="Astell.ps",paper="a4",family="Helvetica",pointsize=12)
